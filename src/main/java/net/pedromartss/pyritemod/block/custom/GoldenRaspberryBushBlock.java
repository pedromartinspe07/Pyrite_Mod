...
public class GoldenRaspberryBushBlock extends SweetBerryBushBlock {
    public GoldenRaspberryBushBlock(Properties properties) {
        super(properties);
    }
    ...
    protected InteractionResult useWithoutItem(BlockState pState, Level pLevel, BlockPos pPos, Player pPlayer, BlockHitResult pHitResult) {
        ...
        if (i > 1) {
            ...
            popResource(pLevel, pPos, new ItemStack(ModItems.GOLDEN_RASPBERRIES.get(), j + (flag ? 1 : 0)));

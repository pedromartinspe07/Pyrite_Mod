package net.pedromartss.pyritemod.worldgen.portal;

import net.pedromartss.pyritemod.block.ModBlocks;
import net.pedromartss.pyritemod.block.custom.ModPortalBlock;
...
public class ModTeleporter {
    ...
    public Entity placeEntity(Entity entity, ServerLevel currentWorld, ServerLevel destinationWorld,
        ...
        if (insideDimension) {
            ...
            if (doSetBlock) {
                destinationWorld.setBlock(destinationPos, ModBlocks.PYRITHEA_PORTAL.get().defaultBlockState(), 3);
            }
        }
